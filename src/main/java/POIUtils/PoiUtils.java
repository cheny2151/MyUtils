...
public class PoiUtils {
     ...
     * 设置表头
     */
    private static Map<String, Object> createHead(HSSFWorkbook workbook, Class<?> entityType) {
    ...
    private static void createCount(HSSFWorkbook workbook, List<?> data, Map<String, Object> headInfo) {
        ...
        for (Object object : data) {
            ...
            Integer size = null;
            if (listField != null) {
                List values = (List) getStringValue(object, listField);
                size = values.size();
            }
            for (Map.Entry<String, Object> entry : headInfo.entrySet()) {
                Object value = getStringValue(object, entry.getKey());
                if (value == null) {
                    value = "-";
                }
                //是否有List
    ...
    private static void setHeadStyle(HSSFWorkbook workbook, HSSFCell cell) {
    ...
    private static void setCountStyle(HSSFWorkbook workbook, HSSFCell cell) {
        HSSFCellStyle countStyle = workbook.createCellStyle();
        setCenterStyle(countStyle, cell);
        setBorder(countStyle, cell);
    }

    private static void setCenterStyle(HSSFCellStyle cellStyle, HSSFCell cell) {
        cellStyle.setAlignment(HorizontalAlignment.CENTER);
        cellStyle.setVerticalAlignment(VerticalAlignment.CENTER);
        cell.setCellStyle(cellStyle);
    }

    private static void setBorder(HSSFCellStyle cellStyle, HSSFCell cell) {
    ...
    private static void setRegionBorder(CellRangeAddress cellRangeAddress, HSSFSheet sheet) {
    ...
    private static void setBoldFont(HSSFCellStyle cellStyle, HSSFWorkbook workbook, HSSFCell cell) {
     ...
     * 设置单元格内容
     */
    private static HSSFCell setValue(HSSFSheet sheet, int row, int column, String value) {
     ...
     * 反射获取字段值
     */
    private static Object getStringValue(Object obj, String fieldName) {
